...
type AutoResult<id> = id extends 0
    ? HMagazinesResult
    : id extends 2
      ? HGameCGResult
      : id extends 5 | 6 | 51 | 52 | 53
        ? PixivResult
        : id extends 8
          ? NicoNicoSeigaResult
          : id extends 9
...
const SauceNAO = {
    ...
    async availableAttempts(): Promise<number> {
        const res = await saucenao({
            db: 999,
            url: "https://saucenao.com/images/static/banner_large.gif",
        });
